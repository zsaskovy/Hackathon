function strategyWeights(marine)
    local weights = {
        ...
        Aggressive ={ HasWeapon = 1, EnemyNear = 5, Health=0.1, Armor=0.9, CanDodge=0.0, Invisible=3.0, Wounds=0.1, AttackPoints=0.9, Accuracy=0.0, Deadly=0.9, MaxRange=0.0, IgnoresSight=0.0, IgnoresFailedDices=0.0, CanDoAimed=0.0, AttackCount=0.9, MovePoints=0.0, IgnoresCollisions=0.0, MoveCount=0.0 }
    }
